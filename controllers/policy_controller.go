...
func (r *PolicyReconciler) handlePolicyReconciliation(ctx context.Context, policyResource *s3v1alpha1.Policy) (reconcile.Result, error) {
	...
	// Create S3Client
	s3Client, err := r.getS3InstanceForObject(policyResource)
	if err != nil {
...
func (r *PolicyReconciler) getS3InstanceForObject(policyResource *s3v1alpha1.Policy) (factory.S3Client, error) {
	return r.S3ClientCache.GetS3Instance(policyResource.Name, policyResource.Namespace, policyResource.Spec.S3InstanceRef)
}
