...
func (in *S3InstanceSpec) DeepCopyInto(out *S3InstanceSpec) {
	*out = *in
	if in.CaCertificatesBase64 != nil {
		in, out := &in.CaCertificatesBase64, &out.CaCertificatesBase64
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
